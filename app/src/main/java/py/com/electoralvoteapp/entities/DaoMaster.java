...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        TableVotesDao.createTable(db, ifNotExists);
        CandidatesDao.createTable(db, ifNotExists);
        VotesDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        NotificationsDao.dropTable(db, ifExists);
        TableVotesDao.dropTable(db, ifExists);
        CandidatesDao.dropTable(db, ifExists);
        VotesDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(TableVotesDao.class);
        registerDaoClass(CandidatesDao.class);
        registerDaoClass(VotesDao.class);
    }
